      ...
      <div className="contact-container">
        <div className="social-links-container">
          <div className="social-links">
            ...
            <a href="https://www.linkedin.com/in/amruta-kadam-6b3bbb312" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
              <i className="fab fa-linkedin"></i>
            </a>
            {/* Twitter Profile Link */}
            <a href="https://x.com/_amrutakadam?t=6lfeO5Ej6q9ZSJv0hT4vkQ&s=08" target="_blank" rel="noopener noreferrer" aria-label="Twitter Profile">
              <i className="fab fa-twitter"></i>
            </a>
            {/* GitHub Profile Link */}
            <a href="https://github.com/KadamAmruta03" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile">
              <i className="fab fa-github"></i>
            </a>
            {/* Email Link */}
            <a href="mailto:kadamamruta0555@gmail.com" aria-label="Email Me">
