...
import profilePic from './images/amru.jpg';
            ...
            <div className="profile-section">
              ...
              <ul className="profile-education-list">
                <li>
                  ...
                  <p>Semester 1 SGPA: 9.68 | Semester 2 SGPA: 9.9</p>
                </li>
                <br></br>
                <li>
                ...
                <li>
                  ...
                  <p>Abhyudaya Education Society High School, kalachowki, Mumbai</p>
                  <p>SSC Board (90%)</p>
                </li>
              </ul>
            </div>
